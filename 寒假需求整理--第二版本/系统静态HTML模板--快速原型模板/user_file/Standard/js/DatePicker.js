...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendarTitle{background:#EDF3F9;text-align:center;height:6px;line-height:6px;clear:both;width:100%;}";
...
Date.prototype.format = function(style) {
  var o = {   
    ...
    "w+" : "日一二三四五僿".charAt(this.getDay()),   //week   
...
Calendar.language = {
	...
	"months":[["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],
			["一暿","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一暿","十二暿"]
        	],
	"weeks":[["S","M","T","W","T","F","S"],
  			["敿","一","丿","䶿","噿","丿","僿"]
			],
